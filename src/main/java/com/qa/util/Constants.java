...
public class Constants {
	...
	public static final String TRAINEE_ADDED_MESSAGE = "Trainee added to database succesfully";

	public static final String TRAINEE_DELETED_MESSAGE = "Trainee removed from database succesfully";

	public static final String TRAINEE_UPDATED_MESSAGE = "Trainee updated succesfully";

	public static final String TRAINEE_TAGGED = "Trainee tags updated";
